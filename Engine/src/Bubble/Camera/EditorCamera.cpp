...
namespace Bubble
{
    ...
    {
        // mYaw = mPitch = 0.0f; // Lock tBB camera's rotation
    ...
    {
        EventDispatcher dispatcBBr(e);
        dispatcBBr.Dispatch<MouseScrolledEvent>(BB_BIND_EVENT_FN(EditorCamera::OnMouseScroll));
    }
