...
namespace Bubble
{
    ...
    {
        BB_CORE_ASSERT(entity.HasComponent<IDComponent>());
    ...
    bool SceneSerializer::Deserialize(const std::string& filepath)
    {
        ...
        BB_CORE_TRACE("Deserializing scene '{0}'", sceneName);
        ...
        if(entities)
        {
            for(auto entity : entities)
            {
                ...
                BB_CORE_TRACE("Deserialized entity with ID = {0}, name = {1}", uuid, name);
